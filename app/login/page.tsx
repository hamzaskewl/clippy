...
function LoginInner() {
  ...
  function doLogin() {
    ...
    const url = invite ? `/auth/twitch?invite=${encodeURIComponent(invite)}` : '/auth/twitch'
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="w-full max-w-[440px] p-10">
        ...
        <div className="bg-[#0e0e0e] border border-[#1a1a1a] rounded-lg p-5 mb-6 text-[11px] text-[#666] leading-[1.8]">
          <h3 className="text-[11px] uppercase tracking-wider text-[#888] mb-3 font-medium">before you continue</h3>
        ...
        <label className="flex items-start gap-[10px] mb-6 text-[11px] text-[#666] leading-relaxed cursor-pointer">
          <input
            type="checkbox"
            checked={tosAccepted}
            onChange={(e) => setTosAccepted(e.target.checked)}
            className="mt-[2px] cursor-pointer accent-[#9146ff]"
          />
        ...
        <button
          ...
          onClick={doLogin}
          className="w-full flex items-center justify-center gap-[10px] px-6 py-[14px] bg-[#9146ff] hover:bg-[#7c3aed] text-white rounded-md text-[13px] font-semibold transition-colors disabled:bg-[#1a1a1a] disabled:text-[#333] disabled:cursor-not-allowed"
        >
